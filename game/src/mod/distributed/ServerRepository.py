...
class ServerRepository:
    ...
    def _handleNewConnection(self, newConnection, info):
        ...
        self.notify.info(
            "Got client %s from %s" % (doIdBase, info.netAddress))
    ...
    def sendDoIdRange(self, client):
        ...
        self.sendDatagram(datagram, client.connection)
    ...
    def handleClientCreateObject(self, client, datagram, dgi):
    ...
    def handleClientDeleteObject(self, client, datagram, doId):
    ...
    def handleClientObjectSetZone(self, client, datagram, dgi):

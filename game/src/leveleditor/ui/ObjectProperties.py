...
class Ui_ObjectProperties(object):
    def setupUi(self, ObjectProperties):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 756, 209))
        ...
        self.propertiesView = QtWidgets.QTreeView(self.tabProperties)
        ...
        self.gridLayout_2.addWidget(self.propertiesView, 1, 0, 1, 1)
